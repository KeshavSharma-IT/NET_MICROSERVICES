...
public class ProductsServiceTests
{
    ...
    private readonly eCommerce.BusinessLogicLayer.Services.ProductService _productsService;
    ...
    public ProductsServiceTests()
    {
        ...
        _productsService = new eCommerce.BusinessLogicLayer.Services.ProductService(
    ...
    public async Task AddProduct_ShouldAddValidProduct()
    {
        ...
        var productResponse = _fixture.Create<ProductResponce>();
        ...
        _mapperMock.Setup(m => m.Map<ProductResponce>(It.IsAny<Product>())).Returns(productResponse);
        ...
        result.Should().BeOfType<ProductResponce>();
    ...
    public async Task GetProducts_ShouldReturnAllProducts()
    {
        ...
        var productResponses = _fixture.CreateMany<ProductResponce>(3);

        _productsRepositoryMock.Setup(repo => repo.GetProducts()).ReturnsAsync(products);
        _mapperMock.Setup(m => m.Map<IEnumerable<ProductResponce>>(It.IsAny<IEnumerable<Product>>()))
    ...
    public async Task GetProductByCondition_ShouldReturnProductWhenConditionMatches()
    {
        ...
        _mapperMock.Setup(m => m.Map<ProductResponce>(product)).Returns(productResponse);
    ...
    public async Task UpdateProduct_ShouldUpdateExistingProduct()
    {
        ...
        var updatedProductResponse = _fixture.Create<ProductResponce>();
        ...
        _mapperMock.Setup(m => m.Map<ProductResponce>(updatedProduct)).Returns(updatedProductResponse);
